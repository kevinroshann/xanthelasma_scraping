...
def get_images_from_google(wd, delay, max_images):
    ...
    url = "https://dermnetnz.org/topics/xanthelasma-images"
    wd.get(url)
    ...
    while len(image_urls) < max_images:
        ...
        for image in images:
            ...
            if image.get_attribute('src') and 'http' in image.get_attribute('src'):
                ...
                download_image("imgofweb/", image.get_attribute('src'), str(len(image_urls)) + ".jpg")
...
for i, url in enumerate(urls):
    download_image("imgofweb/", url, str(i) + ".jpg")
